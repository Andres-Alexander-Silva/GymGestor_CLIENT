...
import { RutinaCreate } from "../interface/rutinas.interface";

const ModalCreateRutina = () => {
  const { loading, openModalCreate, handleCloseModalCreate, createRutina } =
    useContext(RutinasContext);
  const style = useStylesModal();
  const methodsRutinas = useForm<RutinaCreate>();
